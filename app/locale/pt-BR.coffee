...
#    submitter: "Submitter"
    ...
    select_changes: "Selecionae duas mudanças abaixo para ver a diferença."
    undo: "Desfazer (Ctrl+Z)"
    redo: "Refazer (Ctrl+Shift+Z)"
    play_preview: "Ver prévia do da fase atual"
    result: "Resultado"
    results: "Resultados"
  ...
  recovered: "Gems de compras anteriores recuperadas. Por favor, atualize a página."
